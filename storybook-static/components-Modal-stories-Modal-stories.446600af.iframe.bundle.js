...
`,ModalFooterTheme=styled_components_browser_esm.Ay.div`
	...
	justify-content: space-between;
	align-items: center;
`,ModalComponent=({children,className,isOpen,onClose,size,theme})=>{const contextValue={onClose};return isOpen?(0,jsx_runtime.jsx)(ModalContext.Provider,{value:contextValue,children:(0,jsx_runtime.jsx)(ModalContainer,{className:classnames_default()(className),children:(0,jsx_runtime.jsx)(ModalDisplay,{className:classnames_default()(className,size,theme),children})})}):null},Modal_Modal=Object.assign(ModalComponent,{Content:({className,children})=>(0,jsx_runtime.jsx)(ModalContentTheme,{className:classnames_default()(className),children}),Header:({className,children})=>{const{onClose}=(()=>{const context=(0,react.useContext)(ModalContext);if(!context)throw new Error("ModalBody must be used within an ModalButtom");return context})();return(0,jsx_runtime.jsxs)(ModalHeaderTheme,{className:classnames_default()(className),children:[children,(0,jsx_runtime.jsx)(md.m6K,{style:{cursor:"pointer",padding:"2px 12px"},onClick:()=>{onClose&&onClose()}})]})},Footer:({className,children})=>(0,jsx_runtime.jsx)(ModalFooterTheme,{className:classnames_default()(className),children})});ModalComponent.__docgenInfo={description:"",methods:[],displayName:"ModalComponent",props:{className:{required:!1,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""},isOpen:{required:!1,tsType:{name:"boolean"},description:""},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:""},theme:{required:!1,tsType:{name:"union",raw:"'dark' | 'light'",elements:[{name:"literal",value:"'dark'"},{name:"literal",value:"'light'"}]},description:""}}};const components_Button=__webpack_require__("./src/components/Button/Button.tsx").A,Example=args=>(0,jsx_runtime.jsxs)(Modal_Modal,{...args,children:[(0,jsx_runtime.jsx)(Modal_Modal.Header,{...args,children:(0,jsx_runtime.jsx)("p",{children:"Modal Header"})}),(0,jsx_runtime.jsx)(Modal_Modal.Content,{...args,children:(0,jsx_runtime.jsxs)("p",{children:[" ","Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut"]})}),(0,jsx_runtime.jsx)(Modal_Modal.Footer,{children:(0,jsx_runtime.jsx)(components_Button,{onClick:()=>null,children:"Close"})})]}),stories_Example=Example;Example.__docgenInfo={description:"",methods:[],displayName:"Example",props:{className:{required:!1,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""},isOpen:{required:!1,tsType:{name:"boolean"},description:""},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:""},theme:{required:!1,tsType:{name:"union",raw:"'dark' | 'light'",elements:[{name:"literal",value:"'dark'"},{name:"literal",value:"'light'"}]},description:""}}};const Modal_stories={title:"UI Components/Modal",component:Modal_Modal,render:stories_Example,argTypes:{theme:{control:"select",options:["light","dark"]},size:{options:["sm","md","lg"],control:"inline-radio"},isOpen:{option:"boolean"}}},ModalLight={args:{theme:"light",size:"lg"}},ModalDark={args:{theme:"dark",size:"lg"}},__namedExportsOrder=["ModalLight","ModalDark"];ModalLight.parameters={...ModalLight.parameters,docs:{...ModalLight.parameters?.docs,source:{originalSource:"{\n  args: {\n    theme: 'light',\n    size: 'lg'\n  }\n}",...ModalLight.parameters?.docs?.source}}},ModalDark.parameters={...ModalDark.parameters,docs:{...ModalDark.parameters?.docs,source:{originalSource:"{\n  args: {\n    theme: 'dark',\n    size: 'lg'\n  }\n}",...ModalDark.parameters?.docs?.source}}}},"./src/components/Button/Button.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>__WEBPACK_DEFAULT_EXPORT__});var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/jsx-runtime.js"),styled_components__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),classnames__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/classnames/index.js"),classnames__WEBPACK_IMPORTED_MODULE_1___default=__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_1__);const ButtonTheme=styled_components__WEBPACK_IMPORTED_MODULE_2__.Ay.button`
	background-color: #e8ebe9;
	color: #4b4d4b;
	padding: 10px 20px;
	border: none;
...
//# sourceMappingURL=components-Modal-stories-Modal-stories.446600af.iframe.bundle.js.map